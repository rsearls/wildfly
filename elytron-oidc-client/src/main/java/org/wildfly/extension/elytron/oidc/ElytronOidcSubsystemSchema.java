...
import static org.wildfly.extension.elytron.oidc.SecureDeploymentDefinition.ALLOW_QUERY_PARAMS;
...
public enum ElytronOidcSubsystemSchema implements PersistentSubsystemSchema<ElytronOidcSubsystemSchema> {
    ...
    public PersistentResourceXMLDescription getXMLDescription() {
        ...
        SimpleAttributeDefinition[] allowQueryParamsObjectAttributes ={ALLOW_QUERY_PARAMS};
        ...
        if (this.since(VERSION_4_0_PREVIEW) && this.enables(ALLOW_QUERY_PARAMS)) {
            secureDeploymentDefinitionBuilder.addAttribute(ALLOW_QUERY_PARAMS, SIMPLE_ATTRIBUTE_PARSER, SIMPLE_ATTRIBUTE_MARSHALLER);
        }
